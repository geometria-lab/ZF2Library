...
class SchemaTest extends \PHPUnit_Framework_TestCase
{
    public function testParseDocblock()
    {
        ...
        DocBlockParser::getInstance()->createSchema('GeometriaLabTest\Model\Persistent\Schema\TestModels\ModelWithOutPrimaryKey');
    }
    ...
    public function testParseMethodTag()
    {
        ...
        DocBlockParser::getInstance()->createSchema('GeometriaLabTest\Model\Persistent\Schema\TestModels\ModelWithMethodNonStatic');
    }
    ...
    public function testCreatePropertyInvalidType()
    {
        ...
        DocBlockParser::getInstance()->createSchema('GeometriaLabTest\Model\Persistent\Schema\TestModels\ModelWithInvalidType');
    }
}
